...
const Navigation:FC<NavigationProps> = ({isTriggerVisible, isAffix}) => {
  ...
  const onChange = (e:ChangeEvent<HTMLSelectElement>) => {
    ...
    return ( <header className={`navigation ${extraClassHeader}`}>
      <div className="navigation-area">
          <div>
            <div className="navigation-title">
              <LinkSite link='https://github.com/angel-luis-dev' icon={<GitHub color='rgb(255,255,255)'/>}/>
              <LinkSite link='https://www.linkedin.com/in/angel-luis-rodr%C3%ADguez-molina-9574a11bb/' icon={<Linkedin color='rgb(255,255,255)'/>}/>
              <LinkSite link='../../assets/document/CV.pdf' icon={<Linkedin color='rgb(255,255,255)'/>}/>
            </div>
          </div>
          <div className="navigation-menu">
            ...
            <select id="select-language" className="language-select" value={language} onChange={onChange}>
